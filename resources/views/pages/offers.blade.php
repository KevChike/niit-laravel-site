...
@section('page_title')
<title>Offers &#8211; {{ config('app.name') }}</title>
@endsection
		...
		<section class="career_fair_section">
			<div class="container">
				<div class="form_bg form_spinner_bg">
					<form id="offer_form" autocomplete="off">
					{{-- <form autocomplete="off"  method="POST" action="{{ url('/offers') }} "> --}}
						 {{-- {{ csrf_field() }}  --}}

						<div class="row">
							<div class="col-md-12">
								<h3 style="color: #0060AC;">Register your interest</h3>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group @if($errors->has('name')) has-error @endif">
									<input type="text" name="name" class="form-control" placeholder="Full Name" maxlength="75" value="{{ old('name') }}" autofocus>
									@if ($errors->has('name'))
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group @if($errors->has('city_of_residence')) has-error @endif">
									<input type="text" name="city_of_residence" class="form-control" placeholder="City of residence" maxlength="18" value="{{ old('city_of_residence') }}">
									@if ($errors->has('city_of_residence'))
									<span class="help-block help-block-error">{{ $errors->first('city_of_residence') }}</span>
								@endif
								</div>
							</div>
						</div>
						<div class="row">		
							<div class="col-md-12">
								<div class="form-group">
									<button class="btn btn-primary" id="submit_form" style="background-color: #1F8CDF;border: 1px solid #0060AC;">Send</button>
								</div>
							</div>
						</div>
					</form>
...
<script type="text/javascript" src="/assets/ajax/offer_form.js"></script>
@endsection
